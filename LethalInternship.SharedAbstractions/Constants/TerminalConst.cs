...
Please CONFIRM or DENY.";
        ...
        public static readonly string TEXT_ERROR_NOERROR = @"Executed successfully.";
        ...
        public static readonly string TEXT_ERROR_SIGNAL = @"Could not send signal. No signal translator detected on the ship.";

        public static readonly string TEXT_BROADCAST_RECALL = @"RETREAT";

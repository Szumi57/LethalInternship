    ...
    public class InteractTriggerPatch
    {
        ...
        public static void Interact_ReversePatch(object instance, Transform playerTransform)
        {
            IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
            {
                ...
                {
                    PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.MapPatches.InteractTriggerPatch.Interact_ReversePatch could not remove CancelLadderAnimation");
                }

...
namespace LethalInternship.Patches.MapPatches
{
    ...
    public class ItemDropShipPatch
    {
        ...
        public static IEnumerable<CodeInstruction> Update_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.MapPatches.ItemDropShipPatch.Update_Transpiler could not bypass condition if interns have to land");
            }
        ...
        {
            if (!InternManagerProvider.Instance.AreInternsScheduledToLand())
            {
                return;
            }
            ...
            InternManagerProvider.Instance.SpawnInternsFromDropShip(__instance.itemSpawnPositions);
        }
        ...
        {
            InternManagerProvider.Instance.ItemDropShipPos = __instance.transform.position;
        }
    }
}

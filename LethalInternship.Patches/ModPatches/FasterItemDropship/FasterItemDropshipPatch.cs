...
namespace LethalInternship.Patches.ModPatches.FasterItemDropship
{
    ...
    public class FasterItemDropshipPatch
    {
                                  ...
                                  Terminal ___terminalScript)
        {
            ...
            {
                if (___terminalScript.orderedItemsFromTerminal.Count > 0 || ___terminalScript.orderedVehicleFromTerminal != -1 || InternManagerProvider.Instance.AreInternsScheduledToLand())
                {
                                   ...
                                   Terminal ___terminalScript)
        {
            if (__instance.IsServer
                ...
                && (___terminalScript.orderedItemsFromTerminal.Count > 0 || ___terminalScript.orderedVehicleFromTerminal != -1 || InternManagerProvider.Instance.AreInternsScheduledToLand()))
            {

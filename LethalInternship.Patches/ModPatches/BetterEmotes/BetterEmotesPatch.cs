...
namespace LethalInternship.Patches.ModPatches.BetterEmotes
{
    public class BetterEmotesPatch
    {
        ...
        public static IEnumerable<CodeInstruction> PerformEmotePrefix_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.ModPatches.BetterEmotesPatch.PerformEmotePrefix_Transpiler could not use irl number of player for iteration.");
            }
            ...
            {
                PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.ModPatches.BetterEmotesPatch.PerformEmotePrefix_Transpiler could not bypass context performed for interns.");
            }
            ...
            {
                PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.ModPatches.BetterEmotesPatch.PerformEmotePrefix_Transpiler could not bypass timeSinceStartingEmote for interns.");
            }

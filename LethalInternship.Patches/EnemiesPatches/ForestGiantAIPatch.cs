...
namespace LethalInternship.Patches.EnemiesPatches
{
    ...
    public class ForestGiantAIPatch
    {
        ...
        public static IEnumerable<CodeInstruction> OnCollideWithPlayer_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.EnemiesPatches.ForestGiantAIPatch.OnCollideWithPlayer_Transpiler could not check if player local or intern");
            }
        ...
        {
            IInternManager manager = InternManagerProvider.Instance;

...
namespace LethalInternship.Patches.EnemiesPatches
{
    ...
    public class FlowermanAIPatch
    {
        ...
        public static IEnumerable<CodeInstruction> KillPlayerAnimationClientRpc_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                PluginLoggerHook.LogError?.Invoke($"LethalInternship.Patches.EnemiesPatches.FlowermanAIPatch.KillPlayerAnimationClientRpc_Transpiler could not check if player local or intern local 1");
            }

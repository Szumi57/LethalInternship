...
namespace LethalInternship.Patches.EnemiesPatches
{
    ...
    internal class ButlerBeesEnemyAIPatch
    {
        ...
        public static IEnumerable<CodeInstruction> OnCollideWithPlayer_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.Logger.LogError($"LethalInternship.Patches.EnemiesPatches.ButlerBeesEnemyAIPatch.OnCollideWithPlayer_Transpiler could not check if local player or intern owner local player");
            }

...
namespace LethalInternship.Patches.ModPatches.MoreEmotes
{
    ...
    internal class MoreEmotesPatch
    {
        ...
        static IEnumerable<CodeInstruction> PerformEmotePrefix_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.ModPatches.MoreEmotesPatch.PerformEmotePrefix_Transpiler could not use irl number of player for iteration.");
            }
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.ModPatches.MoreEmotesPatch.PerformEmotePrefix_Transpiler could not bypass context performed for interns.");
            }
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.ModPatches.MoreEmotesPatch.PerformEmotePrefix_Transpiler could not bypass timeSinceStartingEmote for interns.");
            }

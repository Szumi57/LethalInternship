...
namespace LethalInternship.Patches.ModPatches.MoreEmotes
{
    ...
    internal class MoreEmotesPatch
    {
        ...
        static IEnumerable<CodeInstruction> PerformEmotePrefix_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.NpcPatches.PlayerControllerBPatch.SpectateNextPlayer_Transpiler could not bypass context performed for interns.");
            }
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.NpcPatches.PlayerControllerBPatch.SpectateNextPlayer_Transpiler could not bypass timeSinceStartingEmote for interns.");
            }

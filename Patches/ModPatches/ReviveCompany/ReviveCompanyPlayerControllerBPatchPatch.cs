...
namespace LethalInternship.Patches.ModPatches.ReviveCompany
{
    internal class ReviveCompanyPlayerControllerBPatchPatch
    {
        ...
        public static IEnumerable<CodeInstruction> SetHoverTipAndCurrentInteractTriggerPatch_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.ModPatches.ReviveCompany.ReviveCompanyPlayerControllerBPatchPatch.SetHoverTipAndCurrentInteractTriggerPatch_Transpiler could not check if intern to not send rpc 1");
            }
            ...
            {
                Plugin.LogError($"LethalInternship.Patches.ModPatches.ReviveCompany.ReviveCompanyPlayerControllerBPatchPatch.SetHoverTipAndCurrentInteractTriggerPatch_Transpiler could not check if intern to not send rpc 2");
            }

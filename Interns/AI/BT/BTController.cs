...
using LethalInternship.Interns.AI.BT.ActionNodes;
using LethalInternship.Interns.AI.BT.ConditionNodes;
using LethalInternship.Interns.AI.CoroutineControllers;
using LethalInternship.Utils;

namespace LethalInternship.Interns.AI.BT
{
    public class BTController
    {
        ...
        public void Init()
        {
            ...
            Plugin.LogDebug($"{BTUtil.Export1TreeJson(BehaviorTree)}");
        }
